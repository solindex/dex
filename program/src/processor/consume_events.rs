...
pub(crate) fn process(
    ...
    let invoke_params = solindex_orderbook::instruction::consume_events::Params {
        number_of_entries_to_consume: total_iterations,
    };
    let invoke_accounts = solindex_orderbook::instruction::consume_events::Accounts {
    ...
    if let Err(error) = solindex_orderbook::instruction::consume_events::process(
        program_id,
        invoke_accounts,
        invoke_params,
    ) {
