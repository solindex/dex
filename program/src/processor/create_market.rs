...
pub(crate) fn process(
    ...
    *market_state = DexState {
    ...
    let invoke_params = solindex_orderbook::instruction::create_market::Params {
    ...
    let invoke_accounts = solindex_orderbook::instruction::create_market::Accounts {
    ...
    if let Err(error) = solindex_orderbook::instruction::create_market::process(
        program_id,
        invoke_accounts,
        invoke_params,
    ) {
