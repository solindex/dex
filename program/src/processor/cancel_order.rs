...
pub(crate) fn process(
    ...
    let invoke_params = solindex_orderbook::instruction::cancel_order::Params {
        order_id: *order_id,
    };
    let invoke_accounts = solindex_orderbook::instruction::cancel_order::Accounts {
    ...
    if let Err(error) = solindex_orderbook::instruction::cancel_order::process(
        program_id,
        invoke_accounts,
        invoke_params,
    ) {
